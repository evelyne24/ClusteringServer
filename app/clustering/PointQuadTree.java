...
public class PointQuadTree<T extends PointQuadTree.Item> {
     ...
     * @param bottom
     */
    public PointQuadTree(double left, double right, double top, double bottom) {
        this(new Bounds(left, right, top, bottom));
    }
    ...
    private PointQuadTree(double left, double right, double top, double bottom, int depth) {
        this(new Bounds(left, right, top, bottom), depth);
    }
    ...
    private void split() {
        ...
        mChildren.add(new PointQuadTree<T>(mBounds.left, mBounds.midX, mBounds.top, mBounds.midY, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(mBounds.midX, mBounds.right, mBounds.top, mBounds.midY, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(mBounds.left, mBounds.midX, mBounds.midY, mBounds.bottom, mDepth + 1));
        mChildren.add(new PointQuadTree<T>(mBounds.midX, mBounds.right, mBounds.midY, mBounds.bottom, mDepth + 1));
